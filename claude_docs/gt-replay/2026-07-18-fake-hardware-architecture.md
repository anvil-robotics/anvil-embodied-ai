...
| `home_atol_pos_m` / `home_atol_rot_deg` | replayer ROS params | `0.01` / `5.0` | Homing arrival tolerance — a coarser "did we arrive" check, NOT `GtReplayVerifierNode`'s trajectory-match tolerance |
